...
int edge_function(VERTEX v0, VERTEX v1, VERTEX p)
{
...
void raster_triangle(TRIANGLE* triangle)
{
	...
	for(int vertex = 0; vertex < 3; vertex++)
	{
		...
		vertices[vertex].X = (vertices[vertex].X + 1)*viewport_width/2;
		vertices[vertex].Y = (vertices[vertex].Y + 1)*viewport_height/2;
	}
